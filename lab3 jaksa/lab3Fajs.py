...
vjerojatnostPrijelaza = np.array([[0, 0.6, 0.4], [0.3 , 0, 0.7], [0.8, 0.2, 0]]) #sansa za prijelaz iz jednog stanja u drugo, ne mogu u isto!

matricaGustoce = np.array([[-1/90, 1/150, 1/225], [1/10 , -1/3, 7/30], [4/55, 1/55, -1/11]])
